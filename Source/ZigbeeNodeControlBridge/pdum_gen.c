...
/* NPDU Pool */
PRIVATE pdum_tsNPdu s_asNPduPool[19];
...
extern pdum_tsAPdu s_asAPduPool[1];
...
#endif
    pdum_vNPduInit(s_asNPduPool, 19);
    pdum_vAPduInit(s_asAPduPool, 1);
}
